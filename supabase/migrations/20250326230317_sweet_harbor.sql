/*
  # Add Sample Detention Dates

  1. Changes
    - Add detention slots for the next two weeks
    - Exclude weekends
    - Assign to test teacher account
    - Set reasonable capacity

  2. Notes
    - Uses test teacher ID: a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11
    - Default capacity of 20 students per slot
    - Uses DO block to handle duplicates safely
*/
